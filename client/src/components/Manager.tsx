  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside className="w-[240px] bg-white shadow-md p-4 space-y-4">
          <div className="flex items-center gap-2 text-lg font-bold text-blue-600">
            <img src={book} alt="book" className="w-[32px] h-[32px]" />
            Study Tracker
          </div>
        ...
        <main className="flex-1 p-6 flex flex-col justify-between">
          <div>
            <header className="w-full bg-white h-[65px] px-6 mb-5 shadow-sm border-b border-black-200 flex items-center justify-between">
              {/* Bên trái: nút menu */}
              ...
              {/* Bên phải: icon và avatar */}
              <div className="flex items-center space-x-3 pr-2">
                <button className="hover:text-blue-600">
                  <img src={bell} alt="bell" className="w-8 h-8" />
                </button>
                <button className="hover:text-blue-600">
                   <img src={question} alt="bell" className="w-8 h-8" />
                </button>
                <button className="hover:text-blue-600">
                   <img src={setting} alt="bell" className="w-8 h-8" />
                </button>
                <img
                  src={avatar}
                  alt="Avatar"
            ...
            <div className="flex items-center justify-between mb-3">
              <h1 className="text-xl font-semibold w-[100px] h-[24px]">Môn học</h1>
              <div className="flex space-x-2">
                <select className="border rounded w-[259px] h-[44px] px-4 py-2 text-sm">
                  <option>Lọc theo trạng thái</option>
                  <option>Đang hoạt động</option>
                  <option>Ngừng hoạt động</option>
                </select>
                <button className="flex items-center bg-blue-600 w-[178px] h-[44px] hover:bg-blue-700 text-white px-4 py-2 rounded text-sm">
              ...
              <table className="min-w-full text-sm text-left">
                <thead className="bg-gray-100 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 font-medium text-left w-[235px]">
                      Trạng thái
                    </th>
                    <th className="px-4 py-3 font-medium text-center w-[174px]">
                      Chức năng
                    </th>
                  </tr>
                </thead>
          ...
          {/* Pagination */}
          <div className="flex justify-center items-center space-x-1 mt-6 pt-6">
